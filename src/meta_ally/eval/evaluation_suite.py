...
class EvaluationSuite:
    ...
    def __init__(
        self,
        dataset_managers: DatasetManager | list[DatasetManager] | None = None
    ):
        """
    ...
    def add_dataset_manager(
        ...
        Raises:
            ValueError: If a dataset manager with the same name already exists
        """
        if name is None:
    ...
    def get_dataset_manager(self, name: str) -> DatasetManager | None:
        """
    ...
    def run_evaluation(  # noqa: PLR0913, PLR0917
        self,
        task: Callable,
        evaluators: list[Evaluator] | None = None,
        task_name: str = "evaluation",
        dataset_manager_names: list[str] | None = None,
        dataset_ids: list[str] | None = None,
        retry_task_config: RetryConfig | None = None,
        retry_evaluator_config: RetryConfig | None = None,
        ...
        Raises:
            ValueError: If no dataset managers available or specified manager not found
        """
    ...
    def load(
        cls,
        directory: Path | str,
        dataset_managers: DatasetManager | list[DatasetManager] | dict[str, DatasetManager] | None = None
    ) -> EvaluationSuite:
        """
    ...
    def get_report(self, run_id: str, dataset_id: str) -> Any | None:
        """
    ...
    def get_all_reports(self, run_id: str) -> dict[str, Any] | None:
        """
    ...
    def get_metadata(self, run_id: str) -> EvaluationMetadata | None:
        """
    ...
    def get_stats(self) -> dict[str, Any]:
        ...
        stats = {
            ...
            "unique_tasks": len({m.task_name for m in self._metadata}),
