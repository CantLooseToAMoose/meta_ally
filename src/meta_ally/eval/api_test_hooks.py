...
class APITestHookLibrary(HookLibrary):
    ...
    def __init__(self, auth_manager: Optional[AuthManager] = None):
        ...
        self._tool_manager: Optional[ToolGroupManager] = None
        super().__init__()
    ...
    async def _delete_addone_sources_and_collection(self, inputs: Any) -> None:
        """Delete ADD*ONE sources and collection.
    ...
    async def _delete_addone_copilot(self, inputs: Any) -> None:
    ...
    async def _setup_addone_sources_and_collection(self, inputs: Any) -> None:
